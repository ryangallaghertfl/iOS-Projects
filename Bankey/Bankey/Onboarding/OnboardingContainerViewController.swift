...
//  Bankey
//
//  Created by Ryan Gallagher on 01/10/2023.
//
...
class OnboardingContainerViewController: UIViewController {
    ...
    weak var delegate: OnboardingContainerViewControllerDelegate? //avoid retain cycle, so weak reference
    ...
    override init(nibName nibNameOrNil: String?, bundle nibBundleOrNil: Bundle?) {
        ...
        let page3 = OnboardingViewController(heroImageName: "thumbs", titleText: "Learn more at www.geocities.com/CapitolHill/Fakeusermanuk/Untitled.html")
